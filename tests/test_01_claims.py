...
class TestEndpoint(object):
    ...
    def test_get_claims_id_token_3(self):
        ...
        assert set(claims.keys()) == {"name", "email", "email_verified", "sub", "address"}
    ...
    def test_get_claims_introspection_3(self):
        ...
        self.endpoint_context.cdb["client_1"]["introspection_claims"] = ["name", "email"]
    ...
    def test_get_claims_all_usage(self):
        ...
        assert set(claims.keys()) == {'id_token', 'userinfo', 'introspection', 'access_token'}
